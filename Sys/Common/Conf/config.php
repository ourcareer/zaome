...
return array(
   ...
   /* ContentReplace行为配置 */
    'TMPL_PARSE_STRING'     => array(
        '__JQUERY__'        =>  __ROOT__.'/Src/jquery',
        // '__JQUERYJS__'       =>  '/Src/jquery/jquery-1.11.0.js',
        '__BOOTSTRAP__'     =>  __ROOT__.'/Src/bootstrap',        
    ...
    'PICTURE_UPLOAD' => array(
        ...
        'rootPath' => '/Data/Face/', //保存根路径
        'savePath' => '', //保存路径
        'saveName' => array('uniqid', ''), //上传文件命名规则，[0]-函数名，[1]-参数，多个参数使用数组
        'saveExt'  => '', //文件保存后缀，空则使用原后缀
        'replace'  => ture, //存在同名是否覆盖
